...
public class EventoOrganiza extends Fragment {


    private GridView eventsGridView;
    private EventsVielModel homeViewModel;
    private FragmentEventsBinding binding;
    private AdapterEventsOrganiza adapter;

    public EventoOrganiza() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_event_organiza, container, false);
    ...
    private void populateGridView(List<Evento> lista){
        eventsGridView = (GridView) getView().findViewById(R.id.gridEventoOrganiza);

        if (lista.size() > 0) {
            adapter = new AdapterEventsOrganiza(getContext(), getActivity(), lista);
    ...
    private void exibirErro() {
        ...
        new AlertDialog.Builder(getContext())
                ...
                .setMessage("Você não organiza nenhum evento atualmente, caso crie um o verá aqui.")
